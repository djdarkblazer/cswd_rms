...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      ...
      <br>
      <a class="h1" href="<?= SITE_URL('account/Login'); ?>"><b><span style="color: #EF3A25;">CSWD</span> <span style="color: #2990C3;">VERIFICATION</span></a></b>
    </div>
    <div class="card-body">

      <form action="<?= SITE_URL('account/reset_verification'); ?>" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Verification Code" name="reset_code">
